...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField('Username', max_length = 15, unique=True, blank=False)
    ...
    phone = models.CharField('Phone', max_length = 10, blank=False)
    gender = models.CharField('Gender', max_length=50, blank = True)
    role = models.IntegerField('Role', blank=False)
